      ...
      <main className="flex-1 pt-28 pb-20">
        <section className="bg-slate-900 text-white py-14">
          <div className="container-custom max-w-4xl">
            <span className="text-xs font-bold uppercase tracking-wider text-blue-400">Legal Documentation</span>
            <h1 className="text-3xl sm:text-4xl font-extrabold text-white mt-2">Privacy Policy</h1>
            <p className="text-xs text-slate-400 mt-2">Last Updated: August 02, 2026</p>
          </div>
        </section>

        <section className="section-padding bg-white">
          <div className="container-custom max-w-4xl prose prose-slate prose-sm sm:prose-base space-y-8 text-slate-700 leading-relaxed max-w-[68ch]">
            <div>
            ...
            <div>
              <h2 className="text-xl font-bold text-slate-900 mb-3">2. What Information Do We Collect?</h2>
              <p>
            ...
            <div>
              <h2 className="text-xl font-bold text-slate-900 mb-3">3. How Do We Process Your Information?</h2>
              <p>
            ...
            <div>
              <h2 className="text-xl font-bold text-slate-900 mb-3">4. How Do We Keep Your Information Safe?</h2>
              <p>
            ...
            <div>
              <h2 className="text-xl font-bold text-slate-900 mb-3">6. Your Privacy Rights</h2>
              <p>
            ...
            <div className="p-6 bg-slate-50 rounded-2xl border border-slate-200 not-prose">
              <h3 className="text-base font-bold text-slate-900 mb-2">Contact Our Data Protection Officer (DPO)</h3>
              <p className="text-xs text-slate-600 mb-4">
                If you have questions or comments about this notice, you may contact us by post, phone, or email:
              </p>
              <div className="space-y-1.5 text-xs text-slate-700">
                <p className="font-bold text-slate-900">NextSolves Data Protection Officer</p>
