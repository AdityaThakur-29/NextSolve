      ...
      <main className="flex-1 pt-28 pb-20">
        ...
        <section className="section-padding bg-white">
          <div className="container-custom max-w-4xl prose prose-slate prose-sm sm:prose-base space-y-8 text-slate-700 leading-relaxed max-w-[68ch]">
            <div>
              <h2 className="text-xl font-bold text-slate-900 mb-3">1. Agreement to Our Legal Terms</h2>
              <p>
            ...
            <div>
              <h2 className="text-xl font-bold text-slate-900 mb-3">3. User Representations & Institutional Accounts</h2>
              <p>
            ...
            <div>
              <h2 className="text-xl font-bold text-slate-900 mb-3">4. Examination Integrity & Prohibited Activities</h2>
              <p>
            ...
            <div>
              <h2 className="text-xl font-bold text-slate-900 mb-3">5. Governing Law & Dispute Resolution</h2>
              <p>
            ...
            <div className="p-6 bg-slate-50 rounded-2xl border border-slate-200 not-prose">
              <h3 className="text-base font-bold text-slate-900 mb-2">Contact Us Regarding Legal Terms</h3>
              <p className="text-xs text-slate-600 mb-4">
                In order to resolve a complaint regarding the Services or to receive further information regarding use of the Services, please contact us at:
              </p>
              <div className="space-y-1.5 text-xs text-slate-700">
                <p className="font-bold text-slate-900">NextSolves</p>
