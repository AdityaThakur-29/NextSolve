...
export default function ROICalculator() {
  ...
  return (
    <div className="bg-white rounded-3xl shadow-xl border border-slate-200/90 overflow-hidden">
      {/* Header */}
      <div className="bg-slate-50/70 border-b border-slate-200/80 p-4 sm:p-6 lg:p-8 flex flex-col sm:flex-row sm:items-center justify-between gap-3 sm:gap-4">
        <div className="flex items-center gap-3">
          <div className="w-10 h-10 sm:w-11 sm:h-11 rounded-2xl bg-blue-50 border border-blue-200 text-primary flex items-center justify-center shrink-0">
        ...
        <div className="text-xs font-semibold text-primary bg-blue-50 px-3 py-1 sm:px-3.5 sm:py-1.5 rounded-full border border-blue-200 self-start sm:self-auto shrink-0">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 divide-y lg:divide-y-0 lg:divide-x divide-slate-200/80">
        {/* Inputs */}
        <div className="lg:col-span-6 p-4 sm:p-6 lg:p-8 space-y-5 sm:space-y-6">
          <div>
            ...
            <div className="space-y-3.5 sm:space-y-4">
              ...
              <div className="grid grid-cols-2 gap-2.5 sm:gap-3.5">
                <div>
                  <label htmlFor="ansCost" className="block text-[11px] font-semibold text-slate-600 mb-1 truncate">
                    Answer Sheet Cost (₹)
                  </label>
                  <input
                    id="ansCost"
                ...
                <div>
                  <label htmlFor="qCost" className="block text-[11px] font-semibold text-slate-600 mb-1 truncate">
                    Question Slip Cost (₹)
                  </label>
                  <input
                    id="qCost"
          ...
          <div>
            ...
            <div className="grid grid-cols-2 gap-2.5 sm:gap-3.5">
              <div>
                <label htmlFor="pracSubj" className="block text-[11px] font-semibold text-slate-600 mb-1 truncate">
              ...
              <div>
                <label htmlFor="pracExams" className="block text-[11px] font-semibold text-slate-600 mb-1 truncate">
                  Practicals / Subject
                </label>
                <input
                  id="pracExams"
              ...
              <div>
                <label htmlFor="intSubj" className="block text-[11px] font-semibold text-slate-600 mb-1 truncate">
              ...
              <div>
                <label htmlFor="intExams" className="block text-[11px] font-semibold text-slate-600 mb-1 truncate">
                  Internals / Subject
                </label>
                <input
                  id="intExams"
          ...
          <div>
            ...
            <div className="grid grid-cols-2 gap-2.5 sm:gap-3.5">
              <div>
                <label htmlFor="teaMin" className="block text-[11px] font-semibold text-slate-600 mb-1 truncate">
                  Min Salary (₹)
                </label>
                <input
                  id="teaMin"
              ...
              <div>
                <label htmlFor="teaMax" className="block text-[11px] font-semibold text-slate-600 mb-1 truncate">
                  Max Salary (₹)
                </label>
                <input
                  id="teaMax"
        ...
        {/* Results */}
        <div className="lg:col-span-6 p-4 sm:p-6 lg:p-8 bg-slate-50/50 flex flex-col justify-between gap-5">
          <div className="space-y-4 sm:space-y-5">
            {/* Big Total Savings Banner */}
            <div className="bg-primary text-white p-4 sm:p-6 rounded-2xl shadow-md transition-shadow">
              <div className="text-xs uppercase font-bold tracking-wider text-blue-100 mb-1 flex items-center gap-1.5">
                <Sparkles className="w-4 h-4 shrink-0" /> Projected Total Annual Savings
              </div>
              <div className="text-2xl sm:text-4xl font-extrabold tracking-tight tabular-nums">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-2.5 sm:gap-3">
              <div className="bg-white p-3 sm:p-3.5 rounded-xl border border-slate-200 shadow-2xs">
                <div className="text-[11px] font-bold text-slate-500 uppercase tracking-wide truncate">
                  Paper Cost Saved
                </div>
              ...
              <div className="bg-white p-3 sm:p-3.5 rounded-xl border border-slate-200 shadow-2xs">
                ...
                <div className="text-base sm:text-lg font-bold text-rose-600 mt-0.5">
            ...
            <div className="bg-white p-3.5 sm:p-4 rounded-xl border border-slate-200 text-xs text-slate-600 space-y-2">
              <div className="flex items-center gap-2 font-bold text-slate-800">
                <CheckCircle2 className="w-4 h-4 text-primary shrink-0" />
                Operational Impact Highlights:
              </div>
              <ul className="list-disc pl-5 space-y-1 text-slate-500 text-[11px] sm:text-xs">
          ...
          <div className="pt-4 border-t border-slate-200 text-[11px] text-slate-400 text-center leading-normal">
